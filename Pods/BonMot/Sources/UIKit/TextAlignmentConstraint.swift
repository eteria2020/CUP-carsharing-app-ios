...
public class TextAlignmentConstraint: NSLayoutConstraint {
    ...
    @IBInspectable public var firstAlignment: String? {
        didSet {
            firstItemAttribute = BonMot.TextAlignmentConstraint.TextAttribute(ibInspectableString: firstAlignment?.normalized ?? "")
        }
    }

    @IBInspectable public var secondAlignment: String? {
        didSet {
            secondItemAttribute = BonMot.TextAlignmentConstraint.TextAttribute(ibInspectableString: secondAlignment?.normalized ?? "")
        }
    }

    public private(set) var firstItemAttribute: BonMot.TextAlignmentConstraint.TextAttribute = .unspecified
    public private(set) var secondItemAttribute: BonMot.TextAlignmentConstraint.TextAttribute = .unspecified
    ...
    private func distanceFromTop(of item: AnyObject, with attribute: BonMot.TextAlignmentConstraint.TextAttribute) -> CGFloat {
