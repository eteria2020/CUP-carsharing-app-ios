...
class PrivacyStatementViewController : BaseViewController, ViewModelBindable {
    ...
    var viewModel: PrivacyStatementViewModel?
    ...
    func bind(to viewModel: ViewModelType?) {
        guard let viewModel = viewModel as? PrivacyStatementViewModel else {
            return
        }
    ...
    override func viewDidLoad() {
        ...
        self.webview_main.scrollView.zoomScale = 50.0
        self.webview_main.scrollView.minimumZoomScale = 50.0
        self.webview_main.scrollView.minimumZoomScale = 100.0
        ...
        self.lbl_headerTitle.styledText = "lbl_privacyStatementHeader".localized().uppercased()
...
extension PrivacyStatementViewController: UIWebViewDelegate {
