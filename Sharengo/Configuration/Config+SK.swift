...
class Config {
    ...
    let signup3_EndPoint = "http://public.sharengo.sk/signup-3/mobile?"
    let forgetPsw_EndPoint = "https://public.sharengo.sk/forgot-password?"
    let signup_EndPoint = "https://public.sharengo.sk/signup/mobile?"
