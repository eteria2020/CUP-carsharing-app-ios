...
@objc open class ZAlertView: UIViewController {
    ...
    static let AlertWidth: CGFloat            = UIScreen.main.bounds.size.width-(UIScreen.main.bounds.size.width*0.1)
    ...
    // Color
    open static var backgroundColor: UIColor?          = UIColor.white
    ...
    func setupViews() {
        ...
        self.alertView.backgroundColor    = ZAlertView.backgroundColor
