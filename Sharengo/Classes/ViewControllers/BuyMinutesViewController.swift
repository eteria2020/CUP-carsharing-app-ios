...
class BuyMinutesViewController : BaseViewController, ViewModelBindable {
    ...
    var viewModel: BuyMinutesViewModel?
    
    // MARK: - ViewModel methods
    
    func bind(to viewModel: ViewModelType?) {
        guard let viewModel = viewModel as? BuyMinutesViewModel else {
            return
        }
    ...
    override func viewDidLoad() {
        ...
        // Views
        self.view.backgroundColor = Color.buyMinutesBackground.value
        ...
        self.view_header.backgroundColor = Color.buyMinutesHeaderBackground.value
        
        // Labels
        self.lbl_headerTitle.textColor = Color.buyMinutesHeaderTitle.value
        self.lbl_headerTitle.styledText = "lbl_buyMinutesHeader".localized().uppercased()
...
extension BuyMinutesViewController: UIWebViewDelegate {
