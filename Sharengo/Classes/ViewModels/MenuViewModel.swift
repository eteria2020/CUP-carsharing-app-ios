...
public final class MenuViewModel : ListViewModelType, ViewModelTypeSelectable {
    ...
    public func updateData() {
        ...
        if KeychainSwift().get("Username") == nil || KeychainSwift().get("Password") == nil  {
            ...
            let munuItem6 = MenuItem(title: "lbl_menuLegal", icon: "ic_legal_note", viewModel: ViewModelFactory.noteLegali())
            ...
            let munuItem10 = MenuItem(title: "lbl_menuLegal", icon: "ic_legal_note", viewModel: ViewModelFactory.noteLegali())
            menuItems.append(menuItem1)
